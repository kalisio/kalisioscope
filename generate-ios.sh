...
$CONVERT -resize 120x120 $OUTPUT/$PRODUCT/ios/icon-40-3x.png
$CONVERT -resize 50x50 $OUTPUT/$PRODUCT/ios/icon-50.png
$CONVERT -resize 100x100 $OUTPUT/$PRODUCT/ios/icon-50-2x.png
$CONVERT -resize 57x57 $OUTPUT/$PRODUCT/ios/icon-57.png
$CONVERT -resize 114x114 $OUTPUT/$PRODUCT/ios/icon-57-2x.png
...
$CONVERT -resize 512x512 -extent 640x1136 $OUTPUT/$PRODUCT/ios/screen-iphone-568h-2x.png
...
$CONVERT -resize 512x512 -extent 750x1334 $OUTPUT/$PRODUCT/ios/screen-iphone-portrait-667h.png
$CONVERT -resize 1024x1024 -extent 1242x2208 $OUTPUT/$PRODUCT/ios/screen-iphone-portrait-736h.png
$CONVERT -resize 1024x1024 -extent 2208x1242 $OUTPUT/$PRODUCT/ios/screen-iphone-landscape-736h.png
$CONVERT -resize 512x512 -extent 768x1004 $OUTPUT/$PRODUCT/ios/screen-ipad-portrait.png
$CONVERT -resize 1024x1024 -extent 1536x2048 $OUTPUT/$PRODUCT/ios/screen-ipad-portrait-2x.png
$CONVERT -resize 512x512 -extent 1024x768 $OUTPUT/$PRODUCT/ios/screen-ipad-landscape.png
$CONVERT -resize 1024x1024 -extent 2048x1536 $OUTPUT/$PRODUCT/ios/screen-ipad-landscape-2x.png
$CONVERT -resize 2048x2048 -extent 2737x2048 $OUTPUT/$PRODUCT/ios/screen-ipad-landscape-ipadpro.png
$CONVERT -resize 2048x2048 -extent 2048x2732 $OUTPUT/$PRODUCT/ios/creen-ipad-portrait-ipadpro.png
